...
class GlobVariables():
    ...
    def __init__(self):
        ...
        self.output_location = '4_icu_only_regions'
        ...
        self.initial_random_population_size = 100
        self.minimum_population_size = 1
        self.maximum_population_size = 1e6
